...
- If you'd like pizza in person, please use the RSVP
- Dietary preferences and helps us 

<https://forms.gle/95M6NungaXxPxRLFA>

## Indenting and Returning

Anyone have any idea what is going on with this code? Why is it returning only a single value?

```{pyodide}
def my_mean(my_list):
  """Computes the mean value of `my_list` and returns it."""
  total = 0
...
## List Comprehensions {auto-animate=true}
...
- Returns `[None, None, None]` because the expression didn't return anything
